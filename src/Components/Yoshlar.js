...
import yoshlar from '../Img/yoshlar.png';
    ...
    return (
        <div >
            ...
            <div className="container saylov">
                <div className="row">
                    <h1>Дўстлик тумани ҳокимининг ҳокимининг ёшлар сиёсати, ижтимоий ривожлантириш ва маънавий-маърифий ишлар бўйича ўринбосари</h1>
                ...
                <div className="row">
                    <img src={yoshlar} />
                    <p style={{ textAlign: "center" }}><h2> Сахатов Нуриддин Мехриддинович</h2>.</p>
